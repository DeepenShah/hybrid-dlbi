...
/** <p> <b>Test Case Name:</b>Webnet_Verify Audience drop down when navigating from Another Page </p>
 ...
 *  <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/9055.aspx</p>
 ...
 *
 */
public class Webnet9055 extends BaseClass{
	...
	public void verifyAudienceAfterNavigatingToAnotherPage(){
		...
		try{
			...
			rm.webElementSync("idiomspinningcomplete");
			if(!webnet.isVisible("webnetchart"))
				throw new IDIOMException("Failed to load webnet page after switching audience.###WebnetPageIsNotLoadedAfterSwitchinAudience");
	...
	public void exceptionCode(Exception ie){
		...
		if(strMsgAndFileName.length==1){
			...
			rm.captureScreenShot("9055-Exception", "fail");
		}else{
			CustomReporter.errorLog("Failure: "+ strMsgAndFileName[0]);
			rm.captureScreenShot("9055-"+strMsgAndFileName[1], "fail");	
		}		
	}
}
