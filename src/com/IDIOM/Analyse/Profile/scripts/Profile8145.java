/********************************************************************
Objective: To verify hover state on each bar of all Charts
...
public class Profile8145 extends BaseClass{
	
	@Test	
	public void test_Profile8145() throws InterruptedException {
