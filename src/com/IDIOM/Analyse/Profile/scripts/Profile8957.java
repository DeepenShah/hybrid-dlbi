...
public class Profile8957 extends BaseClass {
  ...
  public void test_Profile9070() throws Exception {
    ...
    try {
      ...
      // Step 7 : Without adding any queries, navigate to profile page
      ...
      // Step 8: Verify the data in profile summary and demographics
