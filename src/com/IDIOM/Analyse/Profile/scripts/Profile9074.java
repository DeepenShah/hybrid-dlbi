...
public class Profile9074 extends BaseClass {
  ...
  public void test_Profile9072() throws Exception {
    ...
    try {
      ...
      Thread.sleep(3000);
      // Step 5: Click on new audience link ,provide name and click on 'create and save'[Say
      // Audience A]
      String selectedAudienceName1 = cl.createNewAudience("");
      ...
      CustomReporter.log("Change the Audience to - '" + selectedAudienceName1 + "'");
      pageHeader.selectAudienceFromDropDown(selectedAudienceName1);

      // Step 10 - Navigate to any other page like ;hva or webnet " from mega menu
      rm.webElementSync("idiomspinningcomplete");
      rm.webElementSync("pageload");
      Thread.sleep(2000);
      ...
      if (!pageHeader.verifySelectedAudienceInDropDown(selectedAudienceName1))
        throw new IDIOMException("Default Audience does not match with the Audience '"
            + selectedAudienceName1 + "' which was created and selected. ");

      CustomReporter
          .log("Audience '"
              + selectedAudienceName1
