...
/********************************************************************
<p>	<b>Test Case Name:<b> Success Metric_2.e.i_Bottom Save Bar - Verify message after selecting and deselecting attributes by remove all.
<p>	<b>Objective:<b> To verify message for no attribute after deselecting all attributes by 'Remove all'.
<p>	<b>Test Case ID:<b> http://qa.digitas.com/SpiraTest/523/TestCase/8578.aspx
<p>	<b>Module:<b> Success Metrics
@author:<b> Abhishek Deshpande
@since:<b> 03-May-2016
**********************************************************************/

public class SuccessMetrics8578 extends BaseClass {
	
	@Test
	public void verifyBottomSaveBar(){
		String strMsg = null;
		ClientList_Page clientListPage=null;
		String strProjectName="Test Case 8578";
		...
		try{
			...
			if(iAfter <= iBefore)
				throw new IDIOMException("Failed to add success metric ###testcase8537-NoSuccessMetricAdded");
			
			CustomReporter.log("Successfully added first metric card");
			rm.captureScreenShot("Test8537MetricCardHasBeenAdded", "pass");
			
			//Click on remove all link			
			...
			//Verify no success metrics message
			 if(!(successMetricPage.getNoSuccessMetricsSelectedMessage().equals(message)))
				 throw new IDIOMException("Failed to verify no success metric message ###testcase8537-NoSuccessMetricmessage");			 
			 
			 CustomReporter.log("No success metrics selected message is displayed");			
