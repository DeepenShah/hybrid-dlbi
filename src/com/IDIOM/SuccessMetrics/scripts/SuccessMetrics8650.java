...
/********************************************************************
<p>	<b>Test Case Name:<b> Success Metrics: default message on removing all selected categories one by one from center area of success metrics.
<p>	<b>Objective:<b> Success Metrics: default message on removing all selected categories one by one from center area of success metrics.
<p>	<b>Test Case ID:<b> http://qa.digitas.com/SpiraTest/523/TestCase/8648.aspx
<p>	<b>Module:<b> Success Metrics
@author:<b> Abhishek Deshpande
@since:<b> 10-May-2016
**********************************************************************/

public class SuccessMetrics8650 extends BaseClass {
	...
	public void removeSuccessMetric(){
		...
		try{
			...
			//Step6: Click on remove all link
			successMetricPage.removeAllSuccessMetricsOrAudienceDefinitionQueries();
			
			//Step7: Verify default success metrics message
			successMetricPage.isVisible("successmetricsdefaultmessage", "");
