...
/** 
 * <p> <b>Test Case Name:</b>*Media Ranker Overview_1.b.i.3_Audience & Universe Tabs_.a_Verify_The_Plot_Is_Defaulted_To_Which_Tab</p>
 * <p> <b>Objective:</b> *Objective: Verify the Plot is defaulted to which tab </p>
 * <p> <b>Test Case ID:</bhttp://qa.digitas.com/SpiraTest/523/TestCase/8346.aspx</p>
 * <p> <b>Module:</b> Architect</p>
 * @author Amrutha Nair
 * @since 23-May-2016
 *
 */
public class MediaRanker8346 extends BaseClass {
	...
	String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8346-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8346-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8346_projectname", "fail");
			}
			...
			for (int k=0;k<strMediaRanker.length;k++){
				...
				if(AM.func_VerifyVisibilityOfElement("datepicker", "")){
					...
					//Step 11:Objective: Verify the Plot is defaulted to which tab
					Thread.sleep(5000);
			...
			rm.captureScreenShot("8346", "fail");
		}finally{
			try{
