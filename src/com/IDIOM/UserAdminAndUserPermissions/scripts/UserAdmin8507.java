/********************************************************************
Test Case Name:
User admin: Verify that client assignment is working properly
Test Case ID:http://qa.digitas.com/SpiraTest/523/TestCase/8507.aspx
Objective: This test case checks unassigning all clients from user
...
public class UserAdmin8507 extends BaseClass {

  @Test
  public void test_UserAdmin8507() throws Exception {
    ...
    try {
      ...
      // Step 2: Login in as super user
      ln.func_LoginToIDIOM(emailid, password);
      CustomReporter.log("Logged in successfully as super user");
      ...
      // Step 4: Edit any existing App user and who has clients assigned
