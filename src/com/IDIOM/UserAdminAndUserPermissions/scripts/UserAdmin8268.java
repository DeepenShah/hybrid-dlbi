...
public class UserAdmin8268 extends BaseClass {
  ...
  public void test_UserAdmin8268() throws Exception {
    ...
    try {
      ...
      if (userAdmin.func_ElementExist("Users List")) {
        ...
        // Step 5: Click on any client which is not assigned to any of the selected users
        ...
        // Step 6: Select any client and click on Cancel button from bulk assignment screen
        ...
        // Step 7: Select one or more rows(Say 3 rows)
        selectedUserIndices = userAdmin.func_selectUsers(3,0);
        CustomReporter.log("The Users got selected");

        if (userAdmin.func_ElementExist("Bulk Client Icon")) {
          CustomReporter.log("Bulk Client button is appearing");
        } else {
          CustomReporter.errorLog("Bulk Client button is appearing");
          BaseClass.testCaseStatus = false;
        }
        ...
        // Step 9: Click on any client and click outside bulk assignment screen
        userAdmin.bulkAssignAssignClients(1);

        // Click outside bulk assignment screen
        userAdmin.func_ClickElement("userSearch");
