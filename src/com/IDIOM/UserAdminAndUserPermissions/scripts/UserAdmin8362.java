/********************************************************************
Test Case Name:*Super User Admin - ResultGrid_ExpandedView_Super User Admin View
Test Case ID:http://qa.digitas.com/SpiraTest/523/TestCase/8362.aspx
...
public class UserAdmin8362 extends BaseClass {

  WebElement firstUserRow = null;

  @Test
  public void test_UserAdmin8362() throws Exception {
    ...
    try {
      ...
      if (userAdmin.func_ElementExist("Users List")) {
        ...
        // Step 5:Verify that super admin user can edit first last and email fields on clicking on
        // that
        if (userAdmin.func_VerifyElementReadonly("Name", 0, "test")) {
          CustomReporter.log("The Name field is editable on clicking on it");
        } else {
          CustomReporter.errorLog("The Name field is Not editable on clicking on it");
          BaseClass.testCaseStatus = false;
        }
