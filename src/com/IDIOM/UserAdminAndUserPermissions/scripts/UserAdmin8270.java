...
public class UserAdmin8270 extends BaseClass {
  ...
  public void test_UserAdmin8268() throws Exception {
    ...
    try {
      ...
      if (userAdmin.func_ElementExist("Users List")) {
        ...
        List<Integer> selectedUserIndices = userAdmin.func_selectUsers(2,0);
        ...
        if(userAdmin.verifyBulkAssignClients(1)){
          ...
          CustomReporter.errorLog("Selected Client text color did not turn Blue and rightmark is not appearing");
        }
        
        // Step 7: Click outside bulk assignment screen
