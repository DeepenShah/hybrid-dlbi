...
/** <p> <b>Test Case Name:</b>Manage Projects 2.a.v : Do not save the project by clicking 'X'.</p>
 *  <p> <b>Objective:</b>To check 'X' button effect.</p>
 *  <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/8832.aspx</p>
 ...
 *
 */
public class ClientHomePage8832 extends BaseClass{
	String strClassName = getClass().getSimpleName();
	
	@Test
	public void verifyClickingXOnNewProject(){		
		String strMsg="";
		...
		try{			
			...
			CustomReporter.log("Clicked on 'X' to close project ");
			
			//Verifying project window is closed
			if(rm.webElementSync(clientListPage.projectWindow, "visibilitynowait"))
				throw new IDIOMException("After clicking X, project window should get closed but it is still open.###ProjectWindowFoundOpen");
			...
			if(clientListPage.verfiyProjectIsExist(strClassName))
				throw new IDIOMException("After clicking X, project should not get saved but it is saved###ProjectNameSavedOnClickingX");
