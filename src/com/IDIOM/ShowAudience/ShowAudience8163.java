...
/** 
 * <p> <b>Test Case Name:</b>**Analysis_Show_Audience Widget_Verify_Widget_Hides_After_Selecting_Another_Panel</p>
 * <p> <b>Objective:</b>Verify the "show audience" widget autohides after changing from one "analyze" panel (profile, pathing, HVA, web net) to another.</p>
 * <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/8163.aspx/p>
 * <p> <b>Module:</b> Show Audience</p>
 * @author Amrutha Nair
 * @since 20-June-2016
 *
 */
public class ShowAudience8163 extends BaseClass {
		
	@Test
	public void verifyShowAudiencePanelIsGettingHiddenOnSelectingAnother(){
	String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8163-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8163-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8163_projectname", "fail");
			}
			...
			if(SH.verifyShowAudiencePanelWidth()){
				...
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_ProfileShowAudienceWidth", "fail");
				BaseClass.testCaseStatus=false;
			}
			Thread.sleep(3000);
			
			
			//Step 12:Click on the "pathing" button from megamenu
			...
			if(SH.isVisible("populationpane")){
				strMsg="Show audience panel is visible in pathing page on landing itself";
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_PathingShowAudienceVisible", "fail");
				BaseClass.testCaseStatus=false;
			}
			else{
				strMsg="Show audience panel is not visible in pathing page on landing itself";
				CustomReporter.log(strMsg);
			}
			...
			if(SH.verifyShowAudiencePanelWidth()){
				...
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_PathingShowAudienceWidth", "fail");
				BaseClass.testCaseStatus=false;
			}
			...
			if(SH.isVisible("populationpane")){
				strMsg="Show audience panel is visible in HVA page on landing itself";
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_HVAShowAudienceVisible", "fail");
				BaseClass.testCaseStatus=false;
			}
			else{
				strMsg="Show audience panel is not visible in HVA page on landing itself";
				CustomReporter.log(strMsg);
			}
			...
			if(SH.verifyShowAudiencePanelWidth()){
				...
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_HVAShowAudienceWidth", "fail");
				BaseClass.testCaseStatus=false;
			}
			Thread.sleep(3000);
			
			//Ste 16:Click on the "Web net" button from megamenu
			...
			if(SH.isVisible("populationpane")){
				strMsg="Show audience panel is visible in webnet page on landing itself";
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_webnetShowAudienceVisible", "fail");
				BaseClass.testCaseStatus=false;
			}
			else{
				strMsg="Show audience panel is not visible in webnet page on landing itself";
				CustomReporter.log(strMsg);
			}
			...
			if(SH.verifyShowAudiencePanelWidth()){
				...
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_webnetShowAudienceWidth", "fail");
				BaseClass.testCaseStatus=false;
			}
			
			
			Thread.sleep(3000);
			//Step 18:Click on the "Digital Ranker" button from the megamenu
			...
			if(SH.isVisible("populationpane")){
				strMsg="Show audience panel is visible in digitalRanker page on landing itself";
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_digitalRankerShowAudienceVisible", "fail");
				BaseClass.testCaseStatus=false;
			}
			else{
				strMsg="Show audience panel is not visible in digitalRanker page on landing itself";
				CustomReporter.log(strMsg);
			}
			...
			if(SH.verifyShowAudiencePanelWidth()){
				...
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_digitalRankerShowAudienceWidth", "fail");
				BaseClass.testCaseStatus=false;
			}
			
			Thread.sleep(3000);
			//Step 20:Click on the "TVRanker" button from the megamenu
			...
			if(SH.isVisible("populationpane")){
				strMsg="Show audience panel is visible in tvRanker page on landing itself";
				CustomReporter.errorLog(strMsg);
				rm.captureScreenShot("8163_tvRankerShowAudienceVisible", "fail");
				BaseClass.testCaseStatus=false;
			}
			else{
				strMsg="Show audience panel is not visible in tvRanker page on landing itself";
				CustomReporter.log(strMsg);
			}
				...
				rm.captureScreenShot("8163", "fail");
			}finally{
				try{
