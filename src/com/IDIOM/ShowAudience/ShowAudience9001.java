...
/** <p> <b>Test Case Name:</b>Show_Audience_Widget_Verify it on Profile Page</p>
 *  <p> <b>Objective:</b>Verify Show Audience Widget on Profile Page</p>
 *  <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/9001.aspx</p>
 ...
 *
 */
public class ShowAudience9001 extends BaseClass{
	String strClassName = getClass().getSimpleName();
	
	@Test
	public void verifyShowAudiencePanelOnProfilePage(){		
		String strMsg="";		
		...
		try{
			...
			rm.captureScreenShot("Profile-ProjectedTab", "pass");
			...
			rm.captureScreenShot("Profile-ActualTab", "pass");
			...
			//Step11: Navigate to Profile page
			pageHeader.megaMenuLinksClick(strProfileLink);
			
			Analyse_Profile_Page profilePage = new Analyse_Profile_Page(driver);
			rm.webElementSync("idiomspinningcomplete");
			
			if(!rm.webElementSync(profilePage.homeOwnerGraph, "visibility"))
				throw new IDIOMException("Failed to land on Profile page.###FailedToLandProfilePage");
			
			CustomReporter.log("Navigated to profile page");
			
			//Step12: Open Show Audience window
			profilePage.performAction("showaudience");
			rm.webElementSync("idiomspinningcomplete");
