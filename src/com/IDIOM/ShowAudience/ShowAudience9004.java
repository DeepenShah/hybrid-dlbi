...
/** 
 * <p> <b>Test Case Name:</b>*Show_Audience_Widget_Verify it on Webnet Page</p>
 * <p> <b>Objective:</b>:: Verify Show Audience Widget on Webnet Page</p>
 * <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/9004.aspx/p>
 * <p> <b>Module:</b> Show Audience</p>
 * @author Amrutha Nair
 * @since 20-June-2016
 *
 */
public class ShowAudience9004 extends BaseClass {
		
	@Test
	public void verifyShowAudiencePanelInWebnet(){
	String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###9004-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###9004-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("9004_projectname", "fail");
			}
			...
			//Step 11:	Clickon webnet link from megamenu
			...
			//Step 12:Click on the "show audience" button.
			...
			//Step 13:Compare following data in both Projected and Actual Tabs with previously noted data in step 10:
			...
			if (status){
				...
				throw new IDIOMException(strMsg+"###9004_DataMismatch");
				...
				rm.captureScreenShot("9004", "fail");
			}finally{
				try{
