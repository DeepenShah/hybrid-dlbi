...
/** 
 * <p> <b>Test Case Name:</b>*Analysis_Show_Audience widget_Verify_Population Amount</p>
 * <p> <b>Objective:</b>: Verify Population amount in "Audience" page should be same to Population in "show audience" ..</p>
 * <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/8156.aspx/p>
 * <p> <b>Module:</b> Show Audience</p>
 * @author Amrutha Nair
 * @since 16-June-2016
 *
 */
public class ShowAudience8156 extends BaseClass {
		
	@Test
	public void verifyShowAudiencePanelPopulationInWebnet(){
	String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8156-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8156-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8156_projectname", "fail");
			}
			...
			//Step 10:	Clickon webnet link from megamenu
			...
			webnet.func_ClickElement("showaudience");
			...
			//Step 12:Compare following data in both Projected and Actual Tabs with previously noted data in step 10:
			...
			if (status){
				...
				throw new IDIOMException(strMsg+"###8156_DataMismatch");
				...
				rm.captureScreenShot("8156", "fail");
			}finally{
				try{
