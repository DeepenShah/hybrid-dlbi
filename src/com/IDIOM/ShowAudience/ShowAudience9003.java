...
/** <p> <b>Test Case Name:</b>Show_Audience_Widget_Verify it on HVA Page</p>
 *  <p> <b>Objective:</b>Show_Audience_Widget_Verify it on HVA Page</p>
 *  <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/9003.aspx</p>
 ...
 *
 */
public class ShowAudience9003 extends BaseClass{
	String strClassName = getClass().getSimpleName();
	
	@Test
	public void verifyShowAudiencePanelOnHVAPage(){		
		String strMsg="";		
		...
		try{
			...
			String strHvaLink = property.getProperty("hva");
			...
			rm.captureScreenShot("HVA-ProjectedTab", "pass");
			...
			rm.captureScreenShot("HVA-ActualTab", "pass");
			...
			//Step11: Navigate to HVA page
			pageHeader.megaMenuLinksClick(strHvaLink);
			
			HVA_Page hvaPage = new HVA_Page(driver);
			rm.webElementSync("idiomspinningcomplete");
			
			if(!hvaPage.isVisible("slowdown"))
				throw new IDIOMException("Failed to land on HVA page.###FailedToLandHVAPage");
			
			CustomReporter.log("Navigated to HVA page");
			
			//Step12: Open Show Audience window
			hvaPage.func_ClickElement("showaudience");
			rm.webElementSync("idiomspinningcomplete");
