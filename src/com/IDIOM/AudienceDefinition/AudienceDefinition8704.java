...
/** 
 * <p> <b>Test Case Name:</b>*1978_Verify Default design of Audience Definition panel </p>
 * <p> <b>Objective:</b> Verify the default design of audience builder when no attributes are added to it</p>
 * <p> <b>Test Case ID:</b> http://qa.digitas.com/SpiraTest/523/TestCase/8704.aspx</p>
 * <p> <b>Module:</b> Audience Builder</p>
 * @author Amrutha Nair
 * @since 04-May-2016
 *
 */
public class AudienceDefinition8704 extends BaseClass {
		
	@Test
	public void verifyAudiencePanelDesignt(){
		String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8704-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8704-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8704-ProjectNameissue", "fail");
			}
			...
			//Step 6:Verify audience definition design
			if(AD.isVisible("defaultgroup", "")){
				...
				CustomReporter.errorLog(strMsg);
				BaseClass.testCaseStatus=false;
				rm.captureScreenShot("8704NoDefaultGroup", "fail");
			}
			...
			if(AD.isVisible("addgrouplink", "")){
				...
				throw new IDIOMException(strMsg+" .###8704-AddGroupLinkNotPresent");
			}
			...
			rm.captureScreenShot("8704", "fail");
		}finally{
			try{
