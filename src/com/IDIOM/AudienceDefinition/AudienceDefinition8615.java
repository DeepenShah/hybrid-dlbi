...
/** 
 * <p> <b>Test Case Name:</b> *Audience Definition - a (Categories).i.2 - Verify "Liklihood" demi decile graph for a particular metric</p>
 * <p> <b>Objective:</b> Verify "Liklihood" demi decile graph for a particular metric</p>
 * <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/8615.aspx </p>
 * <p> <b>Module:</b> Audience Builder</p>
 * @author Amrutha Nair
 * @since 06-May-2016
 *
 */
public class AudienceDefinition8615 extends BaseClass {
		
	@Test
	public void verifyDemiDecileGraph(){
		String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8615-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8615-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8615_ProjectName", "fail");
			}
			...
			if(AD.isVisible("demidecilegraph", "")){
				...
				throw new IDIOMException(strMsg+" .###8615-RDemidecileGraphNOTPresent");
			}
			...
			rm.captureScreenShot("8615", "fail");
		}finally{
			try{
