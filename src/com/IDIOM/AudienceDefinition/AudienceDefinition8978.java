...
/** 
 * <p> <b>Test Case Name:</b> *Def 2588 Audience Definition_Verify when user adds filters in default group </p>
 * <p> <b>Objective:</b> Objective:Verify that when user adds queries in default group , the percentage is getting changed immediately without refreshing the page</p>
 * <p> <b>Test Case ID:</b> http://qa.digitas.com/SpiraTest/523/TestCase/8978.aspx </p>
...
public class AudienceDefinition8978 extends BaseClass {
		
	@Test
	public void verifyFilterInDefaultGroup(){
		String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8978-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8978-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8978-ProjectNameissue", "fail");
			}
			...
			CustomReporter.log(strMsg);
			//Step 6:Add some queries in default group				
			...
			strMsg="The population percentage after adding query is :"+PopulationPercent2;
			CustomReporter.log(strMsg);
			
			//Step 7:verify that user is able to see the population percentage change in left panel immediately adding the queries
			if(PopulationPercent1 !=PopulationPercent2){
				CustomReporter.log("The population percentage is changing immediately adding queries to the default group");
			}
			else{
				strMsg="The population percentage is NOT changing immediately after adding queries to the default group"; 
				CustomReporter.errorLog(strMsg);
				throw new IDIOMException(strMsg+" .###8978-PopulationPercentage");
			}
			...
			rm.captureScreenShot("8978", "fail");
		}finally{
			try{
