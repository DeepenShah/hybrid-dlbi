...
/** 
 * <p> <b>Test Case Name:</b> **Audience Definition - a (Categories).i.2.b - Verify click of individual decile or drag their mouse over a range of demi deciles</p>
 * <p> <b>Objective:</b>Objective: Verify click of individual decile or drag there mouse over a range of demi deciles</p>
 * <p> <b>Test Case ID:</b>http://qa.digitas.com/SpiraTest/523/TestCase/8618.aspx </p>
 * <p> <b>Module:</b> Audience Builder</p>
 * @author Amrutha Nair
 * @since 06-May-2016
 *
 */
public class AudienceDefinition8618 extends BaseClass {
		
	@Test
	public void verifyIndividualDemiDecileGraph(){
		String strMsg = null;
		...
		try{
			...
			if(clientListPage.func_ClientListPageElementExist("audiencetab"))
				throw new IDIOMException("Not able to verify new project window###8618-CreateProjectWindow");
			...
			if(!(clientListPage.func_ClientListPageElementExist("audiencetab") && clientListPage.func_ClientListPageElementExist("audiencetablabel")))
				throw new IDIOMException("Fails to land on Audience tab. Problem might be in saving project###8618-AudienceTabNotFound");
			...
			if(pdp.isVisible("projectname", strProjectName)){
				...
				rm.captureScreenShot("8618-ProjectNameissue", "fail");
			}
			...
			if(AD.isVisible("demidecilegraph", "")){
				...
				throw new IDIOMException(strMsg+" .###8618-DemiDecileGraphNotPresnt");
			}
			
			//Step 8:Verify click of individual decile or drag there mouse over a range of demi deciles
			
		 if(AD.verifyDemidecileGraphClickableOrDraggable())
		 {
			    strMsg="The demi decile graph is draggable and selectable in the entire demi decile area";
				CustomReporter.log(strMsg);
		 }
		 else{
			 strMsg="The demi decile graph is NOT draggable and selectable in the entire demi decile area";
			 throw new IDIOMException(strMsg+" .###8618-DemiDecileGraphNotDraggable");
		 }
			...
			rm.captureScreenShot("8618", "fail");
		}finally{
			try{
